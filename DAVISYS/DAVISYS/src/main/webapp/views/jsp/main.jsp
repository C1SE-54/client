	...
	<div class="post" style="">
		<div class="video-detail">
			<div class="video-content">
				...
				<div class="video-p-title anim" style="--delay: .2s;max-width: 400px;word-wrap: break-word;" >${ posts.post.post }
				</div>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								<!-- <div id="close_cmt" data-dismiss="modal">
									...
									<%--																	</c:if>--%>
									<%--																</div>--%>
									<%--																&lt;%&ndash; <c:forEach items="${comments}" var="comment"> &ndash;%&gt;--%>
									<%--																<c:if test="${comment.comment.commentParent ==null}">--%>
									...
									<%--													</div>--%>
									<%--												</form>--%>
									<%--&lt;%&ndash;												<form id="comment-form-${posts.post.ID}" onsubmit="return handleCommentSubmit(event, '${posts.post.ID}')">&ndash;%&gt;--%>
									<%--&lt;%&ndash;													<div class="comment-box">&ndash;%&gt;--%>
									<%--&lt;%&ndash;														<input type="text" id="comment-input${posts.post.ID}" name="postComment" placeholder="Bình luận">&ndash;%&gt;--%>
									<%--&lt;%&ndash;														<button type="submit" class="add-comment-btn">&ndash;%&gt;--%>
									<%--&lt;%&ndash;															<i class="fa-regular fa-comment"></i>&ndash;%&gt;--%>
									<%--&lt;%&ndash;														</button>&ndash;%&gt;--%>
									<%--&lt;%&ndash;													</div>&ndash;%&gt;--%>
									<%--&lt;%&ndash;												</form>&ndash;%&gt;--%>
									<%--												<span class="comment-count">50 bình luận</span>--%>
									<%--&lt;%&ndash;												<c:set var="uniqueUsers" value="${empty uniqueUsers ? new java.util.HashSet() : uniqueUsers}" />&ndash;%&gt;--%>
									<%--&lt;%&ndash;												<c:forEach items="${comments}" var="comment">&ndash;%&gt;--%>
									<%--&lt;%&ndash;													<c:set var="userId" value="${comment.comment.user.ID}" />&ndash;%&gt;--%>
									<%--&lt;%&ndash;													<c:if test="${!uniqueUsers.contains(userId)}">&ndash;%&gt;--%>
									<%--&lt;%&ndash;														<c:set var="uniqueUsers" value="${uniqueUsers.add(userId) ? uniqueUsers : uniqueUsers}" />&ndash;%&gt;--%>
									<%--&lt;%&ndash;													</c:if>&ndash;%&gt;--%>
									<%--&lt;%&ndash;												</c:forEach>&ndash;%&gt;--%>
									<%--&lt;%&ndash;												<span class="comment-count">${uniqueUsers.size()} người đã bình luận</span>&ndash;%&gt;--%>
															...
															<div class="comment__card" id="comments-list${posts.post.ID}">
																<c:if test="${comment.comment.commentParent ==null}">
																	<div class="box-top">
																		<div class="Profile">
																			<div class="profile-image">
																				<img src="${pageContext.request.contextPath}/${comment.comment.user.avatar}"
																					 id="imgUserComment">
																			</div>
																			<div class="Name">
																				<strong>${comment.comment.user.fullname} </strong>
